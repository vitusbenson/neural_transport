...
from neural_transport.plots.plotting.plot_samples_comparison import plot_samples_with_comparison
...
from neural_transport.plots.utilities.plot_utils import load_carbontracker_tests, parse_projections, save_figure
...
def one_to_rule_them_all(args):
    ...
    save_figure(
        fig, args.out_dir, f"trajectory_timeseries_{projections[0].__class__.__name__}", imgformats=["pdf"], dpi=300
    )
